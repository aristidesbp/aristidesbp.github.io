...
(entre na tabela/ cantoinferio direto/ schema)
```
🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥  
# CRIAR APOLICE 
🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥  
...
<!-- ################################################################ -->
 ...
 <div class="grid">
     ...
     <a href="testes.html" class="card">
        ...
        <p>NÃO BAGUNCE SEU SISTEMA! salve os codigos no BLOCO DE NOTAS</p>
    </a>
...
(function() {
    ...
    /**
     * LÓGICA DE IMAGEM: COMPRESSÃO E STORAGE
     */
        ...
        return new Promise((resolve) => {
            ...
            reader.onload = (event) => {
                ...
                img.onload = () => {
                    ...
                    const MAX_SIZE = 800; // Máximo 800px
...
const filePath = `fotos/${Date.now()}_${Math.random().toString(36).substring(7)}.jpg`;
    ...
    window.deleteProduto = async function(id) {
        ...
        try {
            ...
            // Se o produto tinha imagem no Storage, tenta deletar o arquivo físico
