...
# VALE A PENA INVESTIR EM TRAFEGO PAGO?
Imagine que você quer entregar panfletos  no semáforo,(o mesmo exemplo serve para propagandas de TV e jornais impressos, com valores ajustados):

Digamos que gastaria R$250,00 reais pra fazer 100 panfletos, pagaria R$ 50,00 reais para alguém distribuir os panfletos por você.

Quanto você gastaria, para fazer esta campanha através de distribuição de panfletos, R$300,00 reais?

Você acha que SEU FUNCIONÁRIO antes de entregar o panfleto, faria uma pesquisa
com as pessoas para saber se elas realmente estaria interessadas no seu produto, ou TENTARIA VENDER O SEU PRODUTO antes de entregar o panfleto mesmo sabendo que NÃO TEM COMISSÃO POR VENDA, para não acabar desperdiçando o seu investimento? 

SAIBA QUE: o custo pra você alcançar 1000 pessoas (CPM) através de um bom  TRÁFEGO PAGO, CUSTA EM MÉDIA UM TERÇO DO VALOR, e te da o controle para fazer que seu investimento só seja entregue para pessoas que realmente tenham algum interesse no seu produto, pois VOCÊ SÓ PAGA, QUANDO UMA PESSOA INTERESSADA NO SEU PRODUTO, CLICAR NO SEU ANÚNCIO!

Os anúncios online são como panfletos, que podem ser em vídeos, imagens ou textos, mas que vão aparecer na tela do computador ou celular do seu cliente, seja no TikTok,Instagram, Google, YouTube...

# COMO FUNCIONA O TRÁFICO PAGO?
Funcionam com base num leilão. No tráfego pago, existem basicamente 3 coisas que determinam quem vai aparecer e quem não vai:

# 1- LANCE:(CPM)
Quanto eu tô disposto a pagar, por clique ou por impressão.

# 2- QUALIDADE DO ANÚNCIO:(SEO)
A qualidade do anúncio. 
Quão bom é este anúncio?

# 3- TAXA DE AÇÃO ESTIMADA:(CONVERSÃO)
A taxa de ação estimada é a probabilidade da pessoa que vai ver o anúncio realizar o objetivo (que pode ser converter, se envolver, ver um vídeo, etc.), e você melhora a sua taxa de ação estimada melhorando as suas segmentações. 
Assim, a ferramenta vai calcular essa taxa de ação estimada pra decidir o quanto o seu anúncio irá aparecer.


Toda a fonte de tráfego funciona dessa forma, então, você precisa entender essa
base. 
 
"ANUNCIAR ONLINE É SOBRE GANHAR LEILÕES!"


# COMO FUNCIONAM OS PAGAMENTOS?

No universo dos anúncios online você só é cobrado quando o seu ANÚNCIO APARECE (ex:campanha para alcance),ou quando alguém CLICA NO SEU ANÚNCIO (ex:campanha de conversão com filtro).

Então, você nunca vai pagar nada se o seu anúncio não aparecer ou se ninguém clicar no seu anúncio.
...
4) Pagar pelos anúncios que foram veiculados (anúncios que aparecer ou que as pessoas clicaram).
...
4 - Ativar o gatilho do  (“aaaaaah, ele tá falando comigo!”).
...
https://pt-br.facebook.com/ads/library/?active_status=active&ad_type=political_and_issue_ads&country=BR&is_targeted_country=false&media_type=all
...
# COMO APARECER NO TOPO DA PESQUISA DO GOOGLE?
...
# Como escolher palavra chave certa:
1 - use o celebro.
...
abaixo vou te passar uma [PERSONA] e algumas [TAREFAS].Use caixa de texto para respostas, faça com calma não precisa ter pressa.


[TAREFA 1]
[PERSONA]
sou Aristides gestor de tráfego pago
