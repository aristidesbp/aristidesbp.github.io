...
<nav id="navigation">
  <div class="wrapper">
    <a class="logo close" href="#home">aristidesvideo</a>
    <div class="menu">
      <ul>
        <li>
        ...
        <li>
          <a id="knowledgeNav" class="close" href="#knowledge">Conhecimentos</a>
        </li>
        <li>
      ...
      <ul class="social-links">
        <li>
          <a
            href="https://instagram.com/aristidesvidio"
            title="Instagram"
            target="_blank"
          >
          <!-- SVG do Instagram -->
