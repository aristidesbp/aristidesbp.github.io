function themeToggle(container) {
  container.innerHTML = `
    <div id="toggle">
      ...
      <label for="sw-checkbox" title="Mudar tema">
        <!-- Primeiro ícone SVG (Lua para tema escuro) -->
        <svg
        ...
        <!-- Segundo ícone SVG (Sol para tema claro) -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="20"
  ...
  // Adiciona o evento de alternância de tema após o HTML ter sido inserido
  const toggle = container.querySelector("#sw-checkbox");
