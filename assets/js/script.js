...
toggle.addEventListener("change", () => {
  ...
  // Verifica o estado inicial do tema salvo no localStorage
  if (localStorage.getItem('theme') === 'light') {
    document.body.classList.add('light-mode');
    themeToggle.checked = true; // Ativa o checkbox
  }

  // Adiciona um evento ao checkbox para alternar entre temas
  themeToggle.addEventListener('change', () => {
    if (themeToggle.checked) {
      document.body.classList.add('light-mode');
      localStorage.setItem('theme', 'light'); // Salva o estado
    } else {
