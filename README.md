...
OLA MUNDO, BEM-VINDOS AO MEU SITE!
...
```
Abaixo vou te passar 2 códigos depois vou te pedir uma tarefa.
...
## Pedindo para IA a fazer as sessões da página com base no que foi pesquisado.
```
1. Com base nas pesquisas que realizamos, faça minha  NAVBAR eo ADMIN.
2. O "ADMIN" será um painel de controle onde o usuario pode editar e cadastrar todos os outros elementos.
utilize indexddb, base64, Json, quero poder fazer a exportação e a importação do banco de dados.
3. objetivo é que os outros elementos sejam carregados dinamicamente conforme for criados na parte administrativa.
