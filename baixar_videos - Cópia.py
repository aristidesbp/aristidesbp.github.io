...
def painel_download():
    ...
    print("\n[*] Iniciando o download (Qualidade: Até 720p)...")
    print("-" * 50)
    
    # Monta o comando usando sua string de formatação exata
    comando_ytdlp = f'yt-dlp -f "bestvideo[height<=720]+bestaudio/best[height<=720]" "{url}"'
    
    # Executa exibindo a saída para o usuário ver a barra de progresso do yt-dlp
